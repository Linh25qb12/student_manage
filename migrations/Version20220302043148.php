 ...
 */
final class Version20220302043148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE score (score DOUBLE PRECISION NOT NULL, student_id INT NOT NULL, subject_id INT DEFAULT NULL, INDEX IDX_32993751CB944F1A (student_id), INDEX IDX_3299375123EDC87 (subject_id), PRIMARY KEY(score, student_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
